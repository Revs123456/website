...
export const metadata: Metadata = {
  title: 'Tech Salary Insights India 2025 — Know Your Worth',
  description: 'Salary ranges for software engineers in India by role, experience level, and city. Compare frontend, backend, DevOps, and AI/ML salaries. Make informed career decisions.',
  alternates: { canonical: 'https://www.techchampsbyrev.in/salary-insights' },
  openGraph: {
    title: 'Tech Salary Insights India 2025 | TechChampsByRev',
    description: 'Compare software engineering salaries across roles, cities, and experience levels in India.',
    url: 'https://www.techchampsbyrev.in/salary-insights',
  },
};
...
export default async function SalaryInsightsPage() {
  const [insights, settings] = await Promise.all([getSalaryInsights(), getPublicSettings()]);

  if (settings.feature_salary_insights === 'false') {
    return (
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #e2e8f0', paddingTop: 80, paddingBottom: 40 }}>
        <div style={wrap}>
          ...
          <h1 className="text-display-sm">
            {settings.page_salary_insights_title || 'Salary Insights'}
          </h1>
          <p style={{ fontSize: 15, color: '#64748b', marginTop: 8 }}>
            {settings.page_salary_insights_subtitle || 'Know your worth before you negotiate'}
          </p>
        </div>
      </div>
