...
const SOCIALS_TEMPLATE = [
  {
    label: 'Instagram',
    settingUrl: 'social_instagram_url',
    settingHandle: 'social_instagram_handle',
    defaultHref: 'https://www.instagram.com/techchamps_by.rev/',
    defaultHandle: '@techchamps_by.rev',
    color: '#e1306c', bg: '#fdf2f8', border: '#f9a8d4',
    icon: (
  ...
  {
    label: 'LinkedIn',
    settingUrl: 'social_linkedin_url',
    settingHandle: 'social_linkedin_handle',
    defaultHref: 'https://www.linkedin.com/in/revanthkalamshetty/',
    defaultHandle: 'revanthkalamshetty',
  ...
  {
    label: 'YouTube',
    settingUrl: 'social_youtube_url',
    settingHandle: 'social_youtube_handle',
    defaultHref: 'https://www.youtube.com/@RevanthKalamshetty',
    defaultHandle: '@RevanthKalamshetty',
    color: '#ff0000', bg: '#fff5f5', border: '#fecaca',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'WhatsApp',
    settingUrl: 'social_whatsapp_url',
    settingHandle: null,
    defaultHref: 'https://wa.me/917671008062',
    defaultHandle: 'Chat with us',
  ...
  {
    label: 'Gmail',
    settingUrl: 'contact_email',
    settingHandle: 'contact_email',
    defaultHref: 'mailto:connectwithrev@gmail.com',
    defaultHandle: 'connectwithrev@gmail.com',
    color: '#ea4335', bg: '#fff5f5', border: '#fecaca',
    isEmail: true,
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'GitHub',
    settingUrl: 'social_github_url',
    settingHandle: 'social_github_handle',
    defaultHref: 'https://github.com/Revs123456',
    defaultHandle: 'Revs123456',
    color: '#24292e', bg: '#f8fafc', border: '#e2e8f0',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
...
export default function ContactClient({ settings }: { settings: PublicSettings }) {
  const socials = SOCIALS_TEMPLATE.map(s => {
    const href = s.isEmail
      ? `mailto:${settings[s.settingUrl] || s.defaultHandle}`
      : (settings[s.settingUrl] || s.defaultHref);
    const handle = s.settingHandle ? (settings[s.settingHandle] || s.defaultHandle) : s.defaultHandle;
    return { ...s, href, handle };
  });
