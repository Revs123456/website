...
import AnswerEvaluatorWidget from '@/components/AnswerEvaluatorWidget';
  ...
  return (
    <div className="card" style={{ overflow: 'hidden' }}>
      <div style={{ padding: 20 }}>
        ...
        {/* Phase 4 — AI evaluator dropdown */}
        <AnswerEvaluatorWidget questionId={q.id} questionText={q.question} />
      </div>
