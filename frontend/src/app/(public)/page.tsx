  ...
  return (
    <div style={{ background: '#f8fafc' }}>
      ...
      <section style={{ background: '#fff', borderBottom: '1px solid #e2e8f0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="anim-float" style={{ position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(37,99,235,.07) 0%, transparent 70%)', top: -100, left: -100, pointerEvents: 'none' }} />
        <div className="anim-float" style={{ position: 'absolute', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(124,58,237,.06) 0%, transparent 70%)', top: 0, right: -50, pointerEvents: 'none', animationDelay: '1.5s' }} />

        <div style={{ ...wrap, position: 'relative', zIndex: 10, paddingTop: 112, paddingBottom: 80, textAlign: 'center' }}>
          {/* Pill */}
          <div className="anim-fade-up d-1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 28, padding: '6px 16px', borderRadius: 99, background: '#eff6ff', border: '1px solid #bfdbfe', color: '#1d4ed8', fontSize: 12, fontWeight: 600 }}>
          ...
          <h1 className="text-display anim-fade-up d-2" style={{ marginBottom: 20 }}>
            The fastest way to<br /><span className="grad-blue">land a tech job</span>
          </h1>

          <p className="anim-fade-up d-3" style={{ fontSize: 16, color: '#64748b', lineHeight: 1.7, maxWidth: 520, margin: '0 auto 36px', padding: '0 8px' }}>
          ...
          <div className="anim-fade-up d-4" style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center', marginBottom: 52 }}>
          ...
          {/* Stats */}
          <div className="anim-fade-up d-5" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 40, paddingTop: 32, borderTop: '1px solid #f1f5f9' }}>
            {[
      ...
      <section style={{ background: '#f8fafc', borderTop: '1px solid #e2e8f0', padding: '80px 0' }}>
        <div style={{ ...wrap, maxWidth: 860 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 32, alignItems: 'start' }}>
            ...
            ].map(({ name, price, c, border, bg, features, pop }, i) => (
              <ScrollReveal key={name} delay={i * 100} scale>
              <div style={{ background: bg, border: `${pop ? '2px' : '1px'} solid ${border}`, borderRadius: 16, overflow: 'hidden' }}>
                {pop && (
