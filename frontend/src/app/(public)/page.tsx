        ...
        <div className="hero-content" style={{ ...wrap, position: 'relative', zIndex: 10, paddingTop: 'clamp(80px, 10vw, 120px)', paddingBottom: 'clamp(60px, 8vw, 100px)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 'clamp(32px, 6vw, 60px)', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1 1 340px', minWidth: 0 }}>
              ...
              {/* Headline */}
              <TypingHeadline line1={settings.hero_line1} line2={settings.hero_line2} />

              {/* Subheading */}
              <p className="anim-fade-up d-3" style={{ fontSize: 17, color: '#6b7280', lineHeight: 1.8, maxWidth: 480, marginBottom: 44 }}>
                {settings.hero_subheading || 'All-in-one platform to learn skills, build your resume, and get hired faster.'}
              </p>

              {/* CTAs */}
              <div className="anim-fade-up d-4 hero-ctas" style={{ display: 'flex', flexWrap: 'wrap', gap: 14, marginBottom: 48 }}>
                <Link href={settings.hero_cta_primary_href || '/jobs'} className="btn btn-primary btn-lg">{settings.hero_cta_primary_label || 'Browse Jobs'} <ArrowRight size={16} /></Link>
                <Link href={settings.hero_cta_secondary_href || '/services'} className="btn btn-outline btn-lg" style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                  <Sparkles size={16} /> {settings.hero_cta_secondary_label || 'Checkout our Services'}
                </Link>
              </div>
