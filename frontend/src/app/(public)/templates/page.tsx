...
export const metadata: Metadata = {
  title: 'Free ATS-Friendly Resume Templates — Download Instantly',
  description: 'Download free ATS-friendly resume templates for software engineers and developers. Professionally designed, easy to edit, and proven to pass ATS filters.',
  alternates: { canonical: 'https://www.techchampsbyrev.in/templates' },
  openGraph: {
    title: 'Free Resume Templates for Developers | TechChampsByRev',
    description: 'ATS-friendly resume templates. Download for free, edit, and apply with confidence.',
    url: 'https://www.techchampsbyrev.in/templates',
  },
};
...
export default async function TemplatesPage() {
  const [templates, settings] = await Promise.all([getTemplates(), getPublicSettings()]);

  if (settings.feature_templates === 'false') {
    return (
