  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ ...wrap, paddingTop: 48, paddingBottom: 80 }}>
        ...
        {/* Error state */}
        {loadError && (
          <div style={{ textAlign: 'center', padding: '40px 0', marginBottom: 32, background: '#fef2f2', borderRadius: 12, color: '#dc2626', fontSize: 14 }}>
        ...
        {/* Loading state */}
        {loading && !loadError && (
          <div style={{ display: 'flex', justifyContent: 'center', padding: '60px 0', marginBottom: 32 }}>
